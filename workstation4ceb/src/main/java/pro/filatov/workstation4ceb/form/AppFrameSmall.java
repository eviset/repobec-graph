 ...
 */
public class AppFrameSmall extends JFrame implements IModelEditorEventListener {
    ...
    Terminal  tabbedPane = new Terminal();
    private JTextField textFieldPathHexCodes;
    private JTextField textFieldPathMifCodes;
    private StatusBar statusBar;


    private static AppFrameSmall instance;

    public static AppFrameSmall getInstance() {
        if(AppFrameSmall.instance == null) {
            AppFrameSmall.instance = new AppFrameSmall();
        }
        return AppFrameSmall.instance;
    }


    public AppFrameSmall() throws HeadlessException {
...
//        tabbedPane.add("Memory Editor", new MemoryEditor());
       ...
       // splitMain1.setPreferredSize(new Dimension(getWidth(), 0));
        ...
        splitMain0.setTopComponent(tabbedPane);//createPanel("TopPanelMain0")tabbedPane
