      ...
      //  panelChannels.setMaximumSize(new Dimension(100,50));
        ...
        ActionListener chClickListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                nameOutFile.setText(name + "_data.txt");
                filenameTextValuesField.setText(name + "_table.txt");
                addressForTextValues.setText(String.valueOf(ch.getTableAddress()));
            }
        };
        ...
        pathForTarrirovka = new JTextField("D:\\work\\repo\\simulink\\4KKP");
       ...
       // panelTextValues.setBorder(BorderFactory.createTitledBorder("Writing values from text file"));
        ...
        filenameTextValuesField = new JTextField("alpha_table.txt");
        countTextValuesField = new JTextField("4096");
        addressForTextValues = new JTextField("32768");
        ...
        Action performWriteTxtFile = new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
                ...
                Model.getMemoryModel().setAddressForTxtValues(Integer.parseInt(addressForTextValues.getText(), 10));
