...
public class MainModeFace extends JPanel implements IModeFace {
    ...
    public void refreshDataOnFace() {
       ...
       // }
        ...
        alphaAngleText.setText(PacketHelper.getAngle19(resp[18], resp[19], resp[20]));
        betaAngleText.setText(PacketHelper.getAngle19(resp[22], resp[23], resp[24]));
        gammaAngleText.setText(PacketHelper.getAngle19(resp[26], resp[27], resp[28]));
